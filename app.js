...
const CONFIG = {
  ...
  SHIPPING_MESSAGE: "📦 Productos en stock sin mínimo de compra con más de 50% de descuento ✨",
...
function getMenuItems() {
  const items = [{ type: "link", label: "Skincare Asiático en nuestra bodega en Corea", href: "#catalog-section" }];
